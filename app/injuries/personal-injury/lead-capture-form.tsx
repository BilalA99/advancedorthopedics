...
export function PersonalInjuryLeadCaptureForm() {
  ...
  async function onSubmit(values: z.infer<typeof leadSchema>) {
    ...
    await pushAcceptedLead({ acceptance, form_name: 'PersonalInjuryLeadForm', form_source: 'personal-injury', state: values.state, email: values.email, phone: values.phone, firstName: values.firstName, lastName: values.lastName })
