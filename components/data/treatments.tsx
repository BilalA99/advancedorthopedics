...
export const treatmentContentPlaceholders: TreatmentContent[] = [
  ...
  },
  {
    ...
    candidates: {
      ...
      list: [
        "Patients with severe, chronic back or neck pain unresponsive to rehabilitation or injections",
    ...
    recovery: {
      heading: "Recovery Expectations",
      timeline: "3-6 Months",
      details: "Recovery depends on the specific procedure. Disc replacement patients often recover motion faster (6-12 weeks). Fusion patients require time for bone healing (3-6 months) before returning to heavy activities. <a href=\"https://mountainspineorthopedics.com/conditions\" class=\"text-blue-600 hover:underline\">**Rehabilitation**</a> is essential for both, focusing on core strengthening and posture to protect the spine. Most patients report a significant reduction in their pre-operative pain.",
    },
    benefits: [
...
export const treatmentContentBatch4: TreatmentContent[] = [
  ...
  },
  {
    ...
    recovery: {
      ...
      details: "Recovery from **Ankle Replacement Surgery** is a gradual process. The ankle is immobilized initially in a splint or cast. Weight-bearing restrictions are in place for several weeks (typically 6 weeks or more). **Rehabilitation** is crucial, usually starting a few weeks after surgery to restore range of motion, strength, balance, and normal gait mechanics. Full recovery, including return to most daily activities, can take 6-12 months. High-impact activities are generally discouraged to preserve implant longevity.",
    },
    benefits: [
...
export const allTreatmentContent: TreatmentContent[] = [
  ...
  },
  {
    ...
    recovery: {
      heading: "Recovery and Return to Activity",
      timeline: "4-6 Months for Full Return to Sports",
      details: "<strong>Recovery from labral repair</strong> requires protection of the repair while it heals. A sling is worn for 4-6 weeks. <a href=\"https://mountainspineorthopedics.com/conditions\" class=\"text-blue-600 hover:underline\">**Rehabilitation**</a> begins with passive motion and progresses to active motion and strengthening. Return to sports typically occurs at 4-6 months once strength and stability milestones are met. The arthroscopic approach allows for faster recovery compared to open surgery, with most patients experiencing significant improvement within the first few months.",
    },
    benefits: [
  ...
  },
  {
    ...
    recovery: {
      ...
      details: "<strong>Recovery from biceps tenodesis</strong> involves protecting the repair while it heals. A sling is worn for 4-6 weeks. <a href=\"https://mountainspineorthopedics.com/conditions\" class=\"text-blue-600 hover:underline\">**Rehabilitation**</a> begins with gentle motion and progresses to strengthening. Most patients experience significant pain relief within the first few weeks. Full recovery typically takes 3-4 months, with return to most activities including sports. The arthroscopic approach allows for faster recovery with minimal scarring.",
    },
    benefits: [
